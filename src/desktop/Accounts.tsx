 ...
 * than the submit, and never sent anywhere else. The add form picks a
 * **provider** from the supported list (GitHub Cloud or GitHub Enterprise
 * Server) instead of a free-form host, so the common case is one click and
 * the Enterprise fields only appear when they're actually needed.
 */
